        ...
        <div className="w-3/5">
            ...
            <div className="mt-1 flex rounded-md shadow-sm">
                <div className="relative flex items-stretch flex-grow focus-within:z-10">
                    ...
                    <input type="text" name="video_search" id="video_search" className="focus:ring-indigo-500 focus:border-indigo-500 block w-full rounded-none rounded-l-md pl-10 sm:text-sm border-gray-300" placeholder="Donda music video" />
                </div>
